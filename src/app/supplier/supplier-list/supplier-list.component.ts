...
export class SupplierListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.contacts = this._supplierService.getSuppliers();
  }
  ...
  private selectItem : any = undefined;
  private contacts:Array<any> = [];

  /*********************************/

  private  get optionsSupplierList():any {
      return (value:string) =>  this._supplierService.getSupplierOptions(value);
   }

  onSelectEventHandler(e: MouseEvent, arg:any):void{
    this.selectItem = arg;
  }
}
